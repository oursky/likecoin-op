...
func decodeBookNFTsParams(args [0]string, argsEscaped bool, r *http.Request) (params BookNFTsParams, _ error) {
	...
	// Decode query: contract_level_metadata_eq.
	if err := func() error {
		cfg := uri.QueryParameterDecodingConfig{
			Name:    "contract_level_metadata_eq",
			Style:   uri.QueryStyleForm,
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotContractLevelMetadataEqVal ContractLevelMetadataEQ
				if err := func() error {
					return paramsDotContractLevelMetadataEqVal.DecodeURI(d)
				}(); err != nil {
					return err
				}
				params.ContractLevelMetadataEq.SetTo(paramsDotContractLevelMetadataEqVal)
				return nil
			}); err != nil {
				return err
			}
...
// TokensByBookNFTAndAccountParams is parameters of tokensByBookNFTAndAccount operation.
type TokensByBookNFTAndAccountParams struct {
	// Evm address of the BookNFT.
	ID string
	// Evm_address of the Account.
	EvmAddress string
...
func unpackTokensByBookNFTAndAccountParams(packed middleware.Parameters) (params TokensByBookNFTAndAccountParams) {
	{
		key := middleware.ParameterKey{
			Name: "id",
			In:   "path",
...
func decodeTokensByBookNFTAndAccountParams(args [2]string, argsEscaped bool, r *http.Request) (params TokensByBookNFTAndAccountParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	// Decode path: id.
	if err := func() error {
		param := args[0]
