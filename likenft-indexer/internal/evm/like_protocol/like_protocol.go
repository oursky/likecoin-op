...
//
// Solidity: event NewBookNFT(address indexed bookNFT, (string,string,string,uint64) config)
func (_LikeProtocol *LikeProtocolFilterer) FilterNewBookNFT(opts *bind.FilterOpts, bookNFT []common.Address) (*LikeProtocolNewBookNFTIterator, error) {
	...
	logs, sub, err := _LikeProtocol.contract.FilterLogs(opts, "NewBookNFT", bookNFTRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event NewBookNFT(address indexed bookNFT, (string,string,string,uint64) config)
func (_LikeProtocol *LikeProtocolFilterer) WatchNewBookNFT(opts *bind.WatchOpts, sink chan<- *LikeProtocolNewBookNFT, bookNFT []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _LikeProtocol.contract.WatchLogs(opts, "NewBookNFT", bookNFTRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
