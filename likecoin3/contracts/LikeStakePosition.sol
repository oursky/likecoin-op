    ...
    ERC721URIStorageUpgradeable
{
    ...
    event PositionMinted(uint256 indexed tokenId, address indexed to, address indexed bookNFT, uint256 bookId, uint256 amount);
    ...
    function initialize(address initialOwner) public initializer {
        ...
        __ERC721_init("LikeStakePosition", "LSP");
    ...
    function mintPosition(
        ...
        emit PositionMinted(tokenId, to, bookNFT, bookId, stakedAmount);
    }
